...
class GoProGPSExtractor:
    ...
    def get_video_creation_time(self, video_path: str) -> Optional[datetime]:
        ...
        try:
            ...
            output = self._run_command(args).decode('utf-8').strip()
    ...
    def detect_camera_model(self, video_path: str) -> str:
        ...
        try:
            ...
            output = self._run_command(args).decode('utf-8', errors='ignore').strip()
            ...
            output = self._run_command(args).decode('utf-8', errors='ignore')
